function main()
{
    ...
    for ( var i = 0; i < 256; i++ )
    {
        var S = i / 255.0; // [0,1]
        var R = 1.0;
        var G = Math.max( Math.cos( 0.7 * S * Math.PI ), 0.0 );
        var B = Math.max( Math.cos( 0.7 * S * Math.PI ), 0.0 );
    ...
    {
        var id = faces[i];
        var S0 = Math.round(255*(scalars[ id[0] ]-0.1)/(0.8-0.1));
        var S1 = Math.round(255*(scalars[ id[1] ]-0.1)/(0.8-0.1));
        var S2 = Math.round(255*(scalars[ id[2] ]-0.1)/(0.8-0.1));
